function write_equations()::Cint
    ...
    write(output, "\tend\n")
    write(output, "\tc0 = arr[:,1][2:end]\n")
    write(output, "\tappend!(c0,G)\n")
    write(output, "\tm1, x1, y1, z1, px1, py1, pz1 = arr[2,:]\n")
    write(output, "\tm2, x2, y2, z2, px2, py2, pz2 = arr[3,:]\n")
    write(output, "\tC = 1.000000000000; #Speed of light\n")
