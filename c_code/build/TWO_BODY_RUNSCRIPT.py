...
parser.add_argument('m1', type=float, help='mass of the first black hole', metavar='Mass 1')
parser.add_argument('m2', type=float, help='mass of the second black hole', metavar='Mass 2')
parser.add_argument('a', type=float, help='semi-major axis of the binary star system', metavar='Semi-major Axis')
parser.add_argument('--e', type=float, default=0.0, help='eccentricity of the orbit, must be between 0 and 1', metavar = 'eccentricity')
parser.add_argument('-relativity', type=int, default=1, help='whether or not to use PM corrections, 1 for true or 0 for false', metavar = 'REL')
...
newton_p_theta = ( G * m1 * m2 * mu * a )**(0.5)
...
x2, y2, z2 = a / (1 + ( m2 / m1 )), 0, 0
x1, y1, z1 = x2 - a, 0, 0
px2, py2, pz2 = 0.0, p_theta / a, 0.0
px1, py1, pz1 = 0.0, -py2, 0.0

line2 = str(m1) + ' ' + str(x1) + ' ' + str(y1) + ' ' + str(z1) + ' '  + str(px1) + ' ' + str(py1) + ' ' + str(pz1)
line3 = str(m2) + ' ' + str(x2) + ' ' + str(y2) + ' ' + str(z2) + ' ' + str(px2) + ' ' + str(py2) + ' ' + str(pz2)
