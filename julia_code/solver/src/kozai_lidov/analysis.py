...
a_in_KM = a_in * L / KM_CGS             #put semi-major axes in KM
a_out_KM = a_out * L / KM_CGS
...
ax.plot(data['qx1']*L/KM_CGS,data['qy1']*L/KM_CGS,data['qz1']*L/KM_CGS)
ax.plot(data['qx2']*L/KM_CGS,data['qy2']*L/KM_CGS,data['qz2']*L/KM_CGS)
ax.plot(data['qx3']*L/KM_CGS,data['qy3']*L/KM_CGS,data['qz3']*L/KM_CGS)
ax.set_xlabel('x(KM)')
ax.set_ylabel('y(KM)')
ax.set_zlabel('z(KM)')
