...
parser.add_argument('--e', type=float, default=0.0,metavar='NUM',help="eccentricity of the eccentric binary")
...
if LTRACE:
    print ("Commandline: nbodyPM " + str(args.time) + " " + str(args.time_step) + " " + str(order) + " " + str(args.run_number) + " " +  str(G) + " " +  str(rho) + " " + str(phi))
else:
